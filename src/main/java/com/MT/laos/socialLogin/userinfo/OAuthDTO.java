...
public class OAuthDTO {
    ...
    private String nameAttributeKey; // 소셜 로그인별 사용자를 식별하는 고유키 ex) 구글 : sub, 페이스북: id (PK 같은 역할)
    ...
    // 구글, 페이스북 각 소셜 로그인별로 맞는 메서드를 호출해서 객체를 반환하는 로직
    /**
    ...
    public User toEntity(Provider provider, OAuth2UserInfo oAuth2UserInfo) {
        ...
        String generateUserId = (provider != null && providerUserId != null)
