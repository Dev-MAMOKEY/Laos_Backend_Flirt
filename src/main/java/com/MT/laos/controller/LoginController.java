...
import com.MT.laos.DTO.AuthTokensDTO;
import com.MT.laos.DTO.LocalLoginDTO;
import com.MT.laos.DTO.RegisterDTO;
import com.MT.laos.repository.UserRepository;
import com.MT.laos.service.JwtService;
import com.MT.laos.service.LocalLoginService;
import com.MT.laos.service.UserService;
    ...
    public ResponseEntity<?> logout(HttpServletRequest request) {
        ...
        if (user == null) {
            ...
            if (emailClaim.isPresent() && providerClaim.isPresent()) {
                ...
                com.MT.laos.DAO.Provider provider = providerClaim.get();
